...
export default function EditPlanPage() {
  ...
  useEffect(() => {
    if (existingPlan) {
      setForm({
        ...
        maxFileSize: existingPlan.maxFileSize || 32,
  ...
  const handleChange = (
    ...
    setForm((prev) => ({
      ...prev,
      [name]: ["price", "numberOfFiles", "numberOfEssayWriter", "numberOfEssayGrader", "maxFileSize"].includes(name)
        ? +value
        : value,
    }));
  };
      ...
      <div className="max-w-5xl mx-auto">
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <Label className="flex items-center gap-2">
                <FileText className="h-4 w-4" /> Maximum File Size (MB)
              </Label>
              <Input
                type="number"
                name="maxFileSize"
